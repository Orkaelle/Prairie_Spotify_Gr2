...
## CREATION TABLES
cur.execute('CREATE TABLE artiste (id_artiste INTEGER PRIMARY KEY AUTOINCREMENT, nom_artiste TEXT);')
cur.execute('CREATE TABLE titre (id_titre INTEGER PRIMARY KEY AUTOINCREMENT, nom_titre TEXT, durée REAL, bpm REAL, energie REAL, intensité REAL, id_spotify text);')
